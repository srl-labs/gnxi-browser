...
declare -A gnsi_credentialz_git_refs
gnsi_credentialz_git_refs["v1.0.0"]="6acb1b496c2057d9c61d3f6d96e35e699edab7f4"

# genereate proto docs
function gen-gnsi-credentialz {
    if [ -z "$1" ]; then
    ...
    git_ref=$(_get_git_ref gnsi_credentialz_git_refs "$1")
