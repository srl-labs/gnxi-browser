...
declare -A gnoi_system_git_refs
gnoi_system_git_refs["v0.1.1"]="1727ed93255496ca59683f8f557f9519026ed345"
gnoi_system_git_refs["v0.1.0"]="c553e567c5f917bc349952ea47b2c4df854962c9"


# genereate gNMI proto docs
function gen-gnoi-system {
    if [ -z "$1" ]; then
    ...
    git_ref=$(_get_git_ref gnoi_system_git_refs "$1")
